...
* **SMS-EMAIL-PUSH Notification - Bildirim Sistemi**
    * *Kapsam:* .NET ekosisteminde ölçeklenebilir bildirim altyapısı.
    * *Öne Çıkanlar:* Dependency Injection ve Serilog entegrasyonu.
* **Oyun Geliştirme Çalışmaları**
    * *Kapsam:* Godot Engine ve C# kullanılarak geliştirilen 3D/2D projeler.
* **Mobil Uygulama Projeleri**
    * *Kapsam:* Flutter ile çapraz platform (cross-platform) mobil uygulama geliştirme ve prototipler.
